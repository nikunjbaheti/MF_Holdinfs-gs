...
def fetch_json_and_save_csv():
    ...
    output_csv_filename = 'Peer_Comparison.csv'
    ...
    with open(input_csv_filename, 'r') as input_csvfile:
        ...
        for row in reader:
            ...
            url = f'https://www.rupeevest.com/functionalities/get_peer_comparision?schemecode={dynamic_number}'
            ...
            try:
                ...
                # Parse JSON data
                json_data = response.json().get('peer_comparision', [])
