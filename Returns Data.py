...
def fetch_json_and_save_csv():
    ...
    output_csv_filename = 'Returns_Data.csv'
    ...
    with open(input_csv_filename, 'r') as input_csvfile:
        ...
        for row in reader:
            ...
            url = f'https://www.rupeevest.com/functionalities/get_return_data?schemecode={dynamic_number}'
            ...
            try:
                ...
                # Parse JSON data
                json_data = response.json().get('returns_data', [])
                ...
                print(f"Error fetching data for MF Code {mf_code}: {e}")
